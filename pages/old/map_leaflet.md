...
For a more immersive experience, there's a full-screen version <a href="{{site.baseurl}}/pages/map_full.html" target="_blank">here</a> (opens in a new tab/window).
&nbsp;
&nbsp;
</div>
...
<!-- Leaflet stuff -->
<link href="{{site.baseurl}}/assets/js/leaflet.css" rel="stylesheet" />
...
<div id="map"></div>
<!-- places.geojson -->
<link rel="points" type="application/json" href='/assets/js/spam_places.geojson'>
